		...
		<div class="row justify-content-center text-center">
			<div class="col-md-12">
				<div class="text-center text-white footer-alt">
					<!-- ADD EMAIL SUBCRIPTION SIGN UP -->
					<!-- <div>Email Subscription sign up goes here</div> -->
					...
					<p class="copyright_content mb-0 mt-3">
						...
						&copy; M. Etienne. Original design by
						<a
							class="copyright_content"
							target="_blank"
							href="https://themeforest.net/user/srbthemes">SRBThemes.</a
						>
					</p>
				</div>
			</div>
